...
public class PathManager
{
    ...
    public void SetPathTile(int x, int y, PathType type, PathDirection direction)
    {
        var key = (x, y);
    ...
    public void RemovePathTile(int x, int y)
    {
        SetPathTile(x, y, PathType.None, PathDirection.None);
    }

    public void AutoSetDirection(int x, int y)
    {
    ...
    public List<PathTile>? FindPath(PathTile start, PathTile end)
    {
    ...
    public List<List<PathTile>> GetAllValidPaths()
    {
    ...
    public IEnumerable<PathTile> GetAllPathTiles()
    {
